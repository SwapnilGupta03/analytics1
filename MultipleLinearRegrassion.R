...
(ndata2 = data.frame(price=c(60,70), promotion=c(300,400))) #enter any value of price and promotion
...
#Dataset can be divided into train(70%) and test(30%) set to check the accuracy (x values from 
#test are put into equation of training set and y is calculated, Y is already there for test set
#compare both y and find the difference in actual and predicted; accuracy is high is diff is less)
